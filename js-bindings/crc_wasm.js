...
class Hasher{
  constructor() {
    ...
    Object.defineProperty(rsc0, symbolDispose, { writable: true, value: function () {
      ...
      exports0['15'](handleTable4[(handle1 << 1) + 1] & ~T_FLAG);
    }});
    return rsc0;
  }
}

Hasher.prototype.update = function update(arg1) {
...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./crc_wasm.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./crc_wasm.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    ...
    ({ exports: exports3 } = yield instantiateCore(yield module3, {
      '': {
        ...
        '15': exports1['component:crc-wasm/crc64-nvme-hasher#[dtor]hasher'],
        '2': trampoline12,
        '3': trampoline13,
        '4': trampoline14,
        '5': trampoline15,
...
export { crc64NvmeHasher, crc64NvmeHash,  }